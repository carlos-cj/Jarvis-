				...
				while(menu2 == 1) {
					...
					switch(alternativa2) {
						...
						case 1:
							...
							printf("\nOpa, tudo certo? Vamos precisar fazer algumas perguntinhas antes de abrir a opção agenda! Pronto? (S) - Para Sim / (N) - Para Não\n");
							fflush(stdin);
							scanf("%c", &respostaMenu2);
							
							if(respostaMenu2 == 'S'){
								
								printf("\n1º pergunta: Qual a sua meta?\n");
								fflush(stdin);
								scanf("%c", &metaUsuario);
								printf("\n2º pergunta: Quantos dias voce tem até a sua meta?\n");
								fflush(stdin);
								scanf("%c", &diasMeta);
							
							} else {
								
								printf("\nQue pena! Adoraríamos te conhecer um pouco melhor!");
